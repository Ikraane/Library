...
import se.kth.ikran.databas.model.Genre;
...
public class AddBookDialogs extends Dialog<Book>{
    ...
    private void buildAddBookDialog() {
        ...
        grid.add(new Label("Author ID "), 1, 5);
        grid.add(authorIDField, 2, 5);
                ...
                if (b == buttonTypeOk) {
                    if (isValidData()) {
                        result = new Book(
                                ...
                                authorIDField.getText(), nameField.getText());
                    }
                }
